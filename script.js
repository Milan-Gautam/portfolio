...
const blogData = {
                "blogs": [
                  {
  "id": 10,
  "title": "Finding Hidden Data: A Practical Guide to Information Disclosure Vulnerabilities",
  "date": "2026-02-17",
  "image": "https://images.unsplash.com/photo-1563986768609-322da13575f3?w=1200&h=600&fit=crop&crop=center",
  "author": "Milan",
  "excerpt": "Not every exposed piece of data counts as a real vulnerability. Here's how I learned to tell the difference—and where to look for the ones that actually matter.",
  "readTime": "10 min read",
  "content": "<div class=\"blog-article\">\n    <div class=\"article-header\">\n        <p class=\"article-lead\">Information leaks show up in the weirdest places. A verbose error message. A misconfigured cloud bucket. A comment left in the HTML from three years ago that someone forgot to delete. The hard part isn't finding them—it's knowing which ones are actually worth your time.</p>\n    </div>\n    \n    <p>Information disclosure vulnerabilities can pop up in all sorts of ways, especially as applications keep getting more complicated. Unlike some injection attacks where multiple things need to line up just right, information disclosures often lead straight to something useful. What starts as a simple version number in a header might end up helping you find a known exploit for that exact software build.</p>\n\n    <p>In this article, I want to walk through how I spot and think about information disclosure vulnerabilities—the ones that actually matter—and how to use that information for whatever comes next.</p>\n\n    <p>Let's get into it.</p>\n    \n    <h2>What Actually Counts as an Information Disclosure?</h2>\n    <p>An information disclosure happens when an application accidentally shows sensitive data to someone who shouldn't be able to see it. Sometimes that data leads directly to a problem—like finding someone's personal information just sitting there. Other times it helps with future attacks—like hardcoded credentials that let you log into something you shouldn't have access to.</p>\n    \n    <p>But here's the thing I had to learn the hard way: not every piece of exposed data is a vulnerability. When you're testing, you need to figure out what's supposed to be public and what's not. And honestly? It's not always obvious.</p>\n    \n    <p>Let me give you some examples to make this clearer.</p>\n    \n    <h3>What Actually Counts as a Finding</h3>\n    \n    <p>These are the kinds of things I've learned to pay attention to:</p>\n    \n    <ul class=\"styled-list\">\n        <li><strong>Config files with hardcoded credentials.</strong> Things like .env files, build configs, or server configs that have passwords or API keys just sitting there in plain text for anyone to read.</li>\n        <li><strong>API endpoints returning personal data.</strong> When you can access someone else's information because the app didn't check permissions properly. Missing Firebase rules are a classic example of this.</li>\n        <li><strong>Error pages showing stack traces.</strong> When debug mode is left on in production and you get full code snippets or runtime secrets in error messages.</li>\n    </ul>\n    \n    <h3>What Usually Doesn't Count</h3>\n    \n    <p>And here's what I've learned is usually not worth reporting:</p>\n    \n    <ul class=\"styled-list\">\n        <li><strong>Server headers showing versions.</strong> Yeah, it tells you they're running Apache 2.4.49. But that alone isn't a bug. If you can't actually do anything with that information, most programs won't care. A lot of them even list this as out of scope.</li>\n        <li><strong>Directory listings with nothing sensitive.</strong> A listing by itself isn't a problem. It's only a problem if there are actual confidential files in there—backups, configs, customer data that shouldn't be public.</li>\n        <li><strong>HTML comments.</strong> Comments in source code are sloppy, sure. But unless they contain passwords or direct links to internal stuff, they're usually not a finding.</li>\n        <li><strong>Public config files.</strong> Some files are meant to be public—robots.txt, sitemap.xml, package.json. Having them accessible isn't a vulnerability.</li>\n    </ul>\n    \n    <p>The main thing I ask myself now is: how could an attacker actually use this? If I have to stretch to explain the impact, it's probably not worth reporting. If it leads somewhere concrete, I might have something.</p>\n    \n    <h2>Where I Look</h2>\n    \n    <p>Information disclosures show up in a bunch of different places. Here are the main categories I've run into over the years:</p>\n    \n    <ul class=\"styled-list\">\n        <li><strong>Verbose messages and comments.</strong> Error messages that say too much. HTML comments with notes to other developers. References to internal endpoints or hosts that weren't meant to be public.</li>\n        <li><strong>Weak or default credentials.</strong> Admin panels with admin:admin still working. Default logins that never got changed after installation.</li>\n        <li><strong>Broken access controls.</strong> APIs that let you see other people's data. Buckets that anyone can read. Directories with no protection.</li>\n        <li><strong>Injection attacks.</strong> SQLi that dumps database contents. XXE that reads local files. Path traversal that gets you into restricted areas.</li>\n        <li><strong>Security misconfigurations.</strong> Debug mode enabled. CORS policies set too loose. Cloud storage left public.</li>\n    </ul>\n    \n    <p>Let me walk you through each of these with real examples of what I've seen.</p>\n    \n    <h2>1. Verbose Messages and Hidden References</h2>\n    \n    <p>Applications send all kinds of data back to your browser. Most of it you never think twice about. But buried in HTTP responses can be little surprises—comments, debug info, references to stuff you definitely weren't supposed to see.</p>\n    \n    <p>And don't just look at the app itself. Check third-party sites too. GitHub. Jira boards that are public. Trello. Google Docs. You'd be surprised how often companies leave stuff open without realizing it.</p>\n    \n    <h3>HTML Comments</h3>\n    \n    <p>Developers leave comments for each other. Sometimes those comments stick around in production. I've seen comments with things like:</p>\n    \n    <pre><code class=\"language-html\"><!-- TODO: Remove debug endpoint before launch -->\n<!-- API endpoint: https://internal-api.staging.example.com/v2/test -->\n<!-- admin credentials: admin / temp123! (change this) --></code></pre>\n    \n    <p>Every one of those is a lead. The first tells you there might be something worth checking out. The second gives you a whole new target to test. The third... well, that's just handing you the keys.</p>\n    \n    <h3>Version Numbers</h3>\n    \n    <p>A version number by itself isn't a vulnerability. But it's reconnaissance. If I see jQuery 1.4.2 in use, I know there are known XSS vulnerabilities out there. If I see Apache 2.4.49, I know about the path traversal bug from a few years back.</p>\n    \n    <p>Headers often give this away:</p>\n    \n    <pre><code>Server: nginx/1.18.0\nX-Powered-By: PHP/7.4.33</code></pre>\n    \n    <p>Now I know what to look up. I'll check ExploitDB. Check CVE databases. See if there's something public I can try.</p>\n    \n    <h3>Third-Party Platforms</h3>\n    \n    <p>Sometimes the leak isn't on the target site at all. It's on some platform they use. I've found:</p>\n    \n    <ul class=\"styled-list\">\n        <li>Public Jenkins instances with open registration</li>\n        <li>Git repos with hardcoded secrets</li>\n        <li>Project management boards with internal details</li>\n        <li>Google Docs with credentials</li>\n    </ul>\n    \n    <p>A quick Google search for \"target.com\" together with \"jenkins\" or \"target.com\" with \"confluence\" can turn up surprising stuff sometimes.</p>\n    \n    <h2>2. Weak or Default Credentials</h2>\n    \n    <p>You'd think this wouldn't still be a thing in 2026. But honestly? It is. Admin panels with admin:admin. Tomcat with tomcat:tomcat. Routers with root:root. You'd be surprised how often this works.</p>\n    \n    <p>Whenever I find a login page, I try the obvious stuff. SecLists has good wordlists for this. But I also try organization-specific combinations—the company name as username and password. The technology vendor's default credentials from their documentation.</p>\n    \n    <p>And if I get in? Now I'm authenticated. That opens up whole new areas to test that I couldn't see before.</p>\n    \n    <h2>3. Broken Access Controls</h2>\n    \n    <p>This is probably the most common source of information leaks I've run into. The app just doesn't check who should see what.</p>\n    \n    <h3>Directory Listings</h3>\n    \n    <p>When a directory doesn't have an index file, some servers just show you everything in that folder. If that folder happens to contain backups, config files, or user uploads, you've got a finding.</p>\n    \n    <p>I've found directories with:</p>\n    \n    <ul class=\"styled-list\">\n        <li>Database backups</li>\n        <li>Log files with sensitive data</li>\n        <li>Source code</li>\n        <li>Invoices and receipts</li>\n    </ul>\n    \n    <p>Google dorking can help here. Try searching for things like:</p>\n    \n    <pre><code>site:target.com intitle:\"index of\"\nsite:target.com inurl:backup\nsite:target.com ext:sql</code></pre>\n    \n    <h3>IDORs</h3>\n    \n    <p>Insecure Direct Object References are everywhere. The pattern is simple: the app uses something from the request to look up data, and doesn't check if you're actually allowed to see that data.</p>\n    \n    <p>Example I see often:</p>\n    \n    <pre><code>GET /api/invoices/1234\nGET /api/invoices/1235\nGET /api/invoices/1236</code></pre>\n    \n    <p>If changing that number lets me see other people's invoices, that's an IDOR. I try it with numbers. I try it with UUIDs if I can find one valid one. I try it with base64-encoded values. I try everything basically.</p>\n    \n    <h3>Cloud Buckets</h3>\n    \n    <p>S3 buckets. Azure blobs. Google Cloud Storage. Cloudflare R2. They all get misconfigured all the time.</p>\n    \n    <p>There are tools like <code>s3scanner</code> or <code>cloud_enum</code> that can help find these. But sometimes it's as simple as guessing bucket names:</p>\n    \n    <pre><code>https://target.s3.amazonaws.com\nhttps://target-backup.s3.amazonaws.com\nhttps://target-public.s3.amazonaws.com</code></pre>\n    \n    <p>If the bucket listing is enabled, I can browse everything. If not, I might still be able to access specific files if I know or can guess the paths.</p>\n    \n    <h2>4. Injection Attacks</h2>\n    \n    <p>Injections aren't just about RCE or database takeover. They're also great for reading stuff you shouldn't be able to see.</p>\n    \n    <h3>Path Traversal</h3>\n    \n    <p>Any time I see a filename in a parameter, I try to break out of the directory:</p>\n    \n    <pre><code>GET /download?file=report.pdf\n\nI try things like:\nGET /download?file=../../../etc/passwd\nGET /download?file=....//....//....//etc/passwd\nGET /download?file=..;/..;/..;/etc/passwd</code></pre>\n    \n    <p>If it works, I can read any file the app can read. Source code. Config files. Password files. All of it becomes accessible.</p>\n    \n    <h3>XXE</h3>\n    \n    <p>XML External Entity attacks are older but they still work surprisingly often. If the app parses XML I can control, I try this:</p>\n    \n    <pre><code class=\"language-xml\"><?xml version=\"1.0\"?>\n<!DOCTYPE root [\n<!ENTITY file SYSTEM \"file:///etc/passwd\">\n]>\n<root>&file;</root></code></pre>\n    \n    <p>If it works, I'm reading files. I can also use XXE to hit internal systems or do SSRF if I need to.</p>\n    \n    <h3>SSRF</h3>\n    \n    <p>Server-Side Request Forgery lets me make the server request things for me. That might be internal services. It might be the cloud metadata endpoint:</p>\n    \n    <pre><code>http://169.254.169.254/latest/meta-data/\nhttp://169.254.169.254/latest/user-data/</code></pre>\n    \n    <p>Those metadata endpoints can have credentials. IAM roles. API keys. All kinds of useful stuff.</p>\n    \n    <h3>XSS for Data Theft</h3>\n    \n    <p>XSS isn't just about popping alerts. If I find XSS, I can potentially steal:</p>\n    \n    <ul class=\"styled-list\">\n        <li>Cookies (except HttpOnly ones)</li>\n        <li>LocalStorage and SessionStorage</li>\n        <li>Page content</li>\n        <li>Screenshots if I get creative</li>\n    </ul>\n    \n    <p>And if it's blind XSS—where my payload fires in some admin's browser later—I might get access to internal dashboards or functionality I'd never see as a regular user.</p>\n    \n    <h2>5. Security Misconfigurations</h2>\n    \n    <h3>Debug Mode</h3>\n    \n    <p>Some frameworks have debug pages left enabled. Laravel has <code>/_debugbar</code>. Django has debug mode that shows settings when errors happen. ASP.NET has trace.axd. I've seen all of these in production.</p>\n    \n    <p>These pages can show environment variables, database queries, session data, source code. If they're exposed, it's usually a good finding.</p>\n    \n    <h3>CORS Misconfigurations</h3>\n    \n    <p>CORS tells browsers which sites can access resources. If it's set too loose, attackers can read data from their own malicious sites.</p>\n    \n    <p>I test with things like:</p>\n    \n    <pre><code>Origin: https://evil.com\nOrigin: null\nOrigin: https://target.com.evil.com</code></pre>\n    \n    <p>If the response includes <code>Access-Control-Allow-Origin: evil.com</code> and <code>Access-Control-Allow-Credentials: true</code>, that's exploitable. An attacker can make a page that fetches user data and sends it back to themselves.</p>\n    \n    <h2>Putting It All Together</h2>\n    \n    <p>Information disclosures aren't always the most exciting bugs. They don't give you RCE. They don't let you take over accounts directly. But they're the foundation of so much else.</p>\n    \n    <p>A version number leads to an exploit. A comment reveals an internal endpoint. A config file has credentials. A debug page shows database queries. Each one is a breadcrumb. Follow enough of them, and they usually lead somewhere interesting.</p>\n    \n    <p>The key is learning what matters and what doesn't. That comes with time. You'll chase false positives. You'll report things that get marked informative. That's fine. Every one teaches you something for next time.</p>\n    \n    <p>So next time you're testing, look closer at the responses. Check the comments. Try the default passwords. Fuzz those parameters. The data is there. You just have to find it.</p>\n\n    <p>Happy hunting,<br>Milan</p>\n</div>",
  "tags": ["information disclosure", "bug bounty", "methodology", "IDOR", "XXE", "SSRF", "cloud security", "reconnaissance"]
                  },
             {
  "id": 9,
  "title": "Why I Almost Stopped Bug Bounty Hunting (And Still Think About It Sometimes)",
  "date": "2026-01-25",
  "image": "https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?w=1200&h=600&fit=crop&crop=center",
  "author": "Milan",
  "excerpt": "Months of hunting. No payouts. Lots of dead ends. Doubt slowly growing. This is the honest story of why I almost gave up—and why I'm still trying, even without a win yet.",
  "readTime": "7 min read",
  "content": "<div class=\"blog-article\">\n    <div class=\"article-header\">\n        <p class=\"article-lead\">I was sitting in front of my terminal, feeling like I didn’t belong here. Months of hunting. Many reports sent. Not a single paid bounty. Just \"informational\" replies and polite rejection emails.</p>\n    </div>\n    \n    <p>Let me speak honestly for a moment.</p>\n    \n    <p>If you’ve been reading my blog, you’ve seen posts about tools, JavaScript files, and workflows. Maybe it looks like I know exactly what I’m doing.</p>\n\n    <p>I don’t. And there was a time not long ago when I almost stopped completely.</p>\n    \n    <p>To be honest, some days I still feel like that. I haven’t had my first payout yet. So this isn’t a success story. It’s just my real experience.</p>\n    \n    <h2>The Doubt Started Slowly</h2>\n    <p>It didn’t hit all at once. It was slow, like a small leak you don’t notice until everything is empty.</p>\n    \n    <p>My first report? Informational. Next one? Duplicate. Someone else found it before me. Then another informational. Then another duplicate. Then weeks with nothing.</p>\n    \n    <p>I kept telling myself this is normal. That everyone has slow times. That if I keep learning XSS, SQLi, APIs, networking, and all the basics, something will come.</p>\n    \n    <p>But after a couple months, a voice started in my head: <em>Maybe you’re not good at this. Maybe others see things you don’t.</em></p>\n    \n    <p>You read other people’s write-ups and think, \"How did they even think of that?\" At first it’s respect. Later it turns into doubt.</p>\n    \n    <p>And the hard part? The results were zero. No payouts. No confirmed bugs. Nothing.</p>\n    \n    <h2>The Night I Almost Quit</h2>\n    <p>I remember one night clearly.</p>\n    \n    <p>I spent six hours on one target. Checked JavaScript files. Tested endpoints. Used every tool I knew. Found nothing.</p>\n    \n    <p>I closed my laptop at 2 AM and sat in silence thinking, <em>What am I even doing?</em></p>\n    \n    <p>When you give so much time to something and see no results, it really affects your mind.</p>\n    \n    <p>I almost wrote a message saying I was quitting bug hunting.</p>\n    \n    <p>I didn’t send it. But I was very close.</p>\n    \n    <img src=\"https://images.unsplash.com/photo-1516387938699-a93567ec168e?w=1000&auto=format&fit=crop\" alt=\"Person sitting alone with laptop in dark room\" style=\"width:100%; border-radius:8px; margin:20px 0;\">\n    <p class=\"image-caption\">That quiet 2 AM moment many hunters know.</p>\n    \n    <h2>Something People Don’t Talk About</h2>\n    <p>I slowly realized something important: almost everyone goes through this.</p>\n    \n    <p>The hunters you see posting payouts online? They also had months of nothing. They just don’t show that part.</p>\n    \n    <p>We only see the success posts, not the long struggle behind them.</p>\n    \n    <p>I needed to remember that.</p>\n    \n    <h2>What I Changed</h2>\n    <p>I didn’t quit. But I changed how I looked at things.</p>\n    \n    <p>I stopped measuring success by finding bugs. Because that meant every day felt like failure.</p>\n    \n    <p>Now I count small progress as success. Learning something new. Understanding an app better. Writing a small script. Improving my workflow.</p>\n    \n    <div class=\"info-box\">\n        <h4>🧠 A Small Mindset Change</h4>\n        <p>Someone told me: \"Bug hunting isn’t a machine where time always gives results.\" Sometimes you find bugs. Most times you just learn. Both matter.</p>\n    </div>\n    \n    <h2>I Also Changed My Approach</h2>\n    <p>I realized I was doing the same things again and again.</p>\n    \n    <p>So I tried new ideas:</p>\n    \n    <ul class=\"styled-list\">\n        <li><strong>New targets:</strong> I tried smaller programs instead of only big ones.</li>\n        <li><strong>New skills:</strong> I started learning APIs, GraphQL, and deeper networking concepts.</li>\n        <li><strong>Better balance:</strong> I stopped working all night and gave myself rest.</li>\n    </ul>\n    \n    <p>Results didn’t change much yet. Still no payout. But I feel like I’m improving slowly.</p>\n    \n    <h2>The Honest Truth</h2>\n    <p>I’m still hunting. Still waiting. Still hoping for that first accepted bug.</p>\n    \n    <p>I don’t know when it will happen.</p>\n    \n    <p>But I’m still here. Still learning. And some days, that’s enough.</p>\n    \n    <h2>If You Feel The Same</h2>\n    <p>If you’re also struggling right now, remember:</p>\n    \n    <div class=\"key-takeaway\">\n        <h3>You’re not alone.</h3>\n        <p>Many hunters are in this same place. They just don’t talk about it.</p>\n    </div>\n    \n    <div class=\"key-takeaway\">\n        <h3>It’s okay to rest.</h3>\n        <p>Taking a break is not quitting. It helps you come back stronger.</p>\n    </div>\n    \n    <div class=\"key-takeaway\">\n        <h3>Try something new.</h3>\n        <p>New targets, new techniques, new ideas. Even small changes help you grow.</p>\n    </div>\n    \n    <div class=\"key-takeaway\">\n        <h3>Your value isn’t only money.</h3>\n        <p>You are learning difficult skills. Understanding systems. Thinking deeply. That matters.</p>\n    </div>\n    \n    <h2>Where I Am Today</h2>\n    <p>I still hunt, but with better balance.</p>\n    \n    <p>I still get informative replies. Still see others’ success. Still haven’t earned a dollar.</p>\n    \n    <p>But I also know doubt is part of learning.</p>\n    \n    <p>The people who succeed are not the ones who never feel doubt. They are the ones who keep trying.</p>\n    \n    <h2>So If You’re Thinking About Quitting</h2>\n    <p>I wrote this for you.</p>\n    \n    <p>Take a break if needed. Come back when ready.</p>\n    \n    <p>I don’t know when our first bug will come. But I know we’re not alone on this path.</p>\n\n    <p>Take care,<br>Milan</p>\n\n    <div class=\"article-footer\">\n        <p><em>If this story feels familiar, message me. I read everything, and I know many of us are in the same stage.</em></p>\n    </div>\n</div>",
  "tags": ["mental health", "burnout", "struggles", "bug bounty", "personal", "community", "mindset", "honesty"]
},     
                  {
  "id": 8,
